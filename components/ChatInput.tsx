      ...
      <form onSubmit={handleSubmit} className={isReplying ? 'opacity-50' : ''}>
        <div className="relative flex items-center">
          <input
            ...
            className="w-full bg-gray-900/50 border border-neutral-700 rounded-full py-2 pl-4 pr-12 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 transition-all"
            autoComplete="off"
            disabled={isReplying}
          />
          <button 
